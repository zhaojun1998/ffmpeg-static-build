...
RUN \
  git clone -b $FFMPEG_VERSION https://github.com/runner365/ffmpeg_rtmp_h265 && \
  wget $WGET_OPTS -O ffmpeg.tar.bz2 "$FFMPEG_URL" && \
  tar xf ffmpeg.tar.bz2 && \
  cd ffmpeg-* && \
  \cp /ffmpeg_rtmp_h265/flv.h /ffmpeg-*/libavformat/flv.h && \
  \cp /ffmpeg_rtmp_h265/flvdec.c /ffmpeg-*/libavformat/flvdec.c && \
  \cp /ffmpeg_rtmp_h265/flvenc.c /ffmpeg-*/libavformat/flvenc.c && \
